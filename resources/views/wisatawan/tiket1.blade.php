                ...
                qrCodeSection = `
                        <div class="mt-6">
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 flex flex-col items-center">
                                <img src="${qrCodeDataUri}" alt="QR Code Tiket" class="w-40 h-40 border-2 border-blue-200 rounded-lg mb-2">
                                <p class="text-sm text-gray-600 text-center">Gunakan QR Code ini saat boarding</p>
                                <p class="text-xs text-gray-500 mt-1">${ticket.kode_pemesanan}</p>
                            </div>
                        </div>
                    `;
            }
