        ...
        <div class="mb-8">
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold mb-2">Selamat Datang, {{ Auth::user()->name ?? 'Wisatawan' }}! 👋</h1>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $activeTickets ?? 2 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $completedTrips ?? 5 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $pendingPayments ?? 1 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">Rp {{ number_format($totalSpent ?? 1250000, 0, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        @for($i = 1; $i <= 3; $i++)
                            <div class="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-medium text-gray-900">TKT-{{ 10000 + $i * 1111 }}</p>
                                    <p class="text-sm text-gray-500">{{ $i == 2 ? 'Nusa Penida → Sanur' : 'Sanur → Nusa Penida' }}</p>
                                    <p class="text-xs text-gray-400">{{ \Carbon\Carbon::now()->addDays($i)->format('d M Y, H:i') }}</p>
                                </div>
                                <div class="flex-shrink-0">
                                    @if($i == 1)
                                    ...
                                    @else
                                        <span class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">Aktif</span>
                                    @endif
                                </div>
                            </div>
                        @endfor
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900">Pembayaran tiket <span class="font-medium text-blue-600">TKT-12345</span> berhasil diverifikasi</p>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900">Tiket baru <span class="font-medium text-blue-600">TKT-11234</span> berhasil dipesan</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors">
                            <div class="flex items-center justify-between mb-3">
                                <span class="text-sm font-medium text-blue-600">TKT-12345</span>
                                <span class="px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">Lunas</span>
                            </div>
                            <div class="flex items-center justify-between mb-2">
                                <span class="text-lg font-semibold text-gray-900">Sanur</span>
                                <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m-4-4H3" />
                                </svg>
                                <span class="text-lg font-semibold text-gray-900">Nusa Penida</span>
                            </div>
                            ...
                            <div class="mt-3 pt-3 border-t border-gray-100">
                                <a href="{{ route('wisatawan.konfirmasi') }}" class="text-sm text-blue-600 hover:text-blue-800 font-medium">Lihat Detail →</a>
                            </div>
                        </div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-300 transition-colors">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">Belum ada perjalanan lain</h3>
                            <p class="mt-1 text-sm text-gray-500">Pesan tiket baru untuk perjalanan berikutnya</p>
                            <div class="mt-4">
                                <a href="{{ route('wisatawan.pemesanan') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
