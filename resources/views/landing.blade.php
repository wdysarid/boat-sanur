    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div data-aos="fade-right" data-aos-duration="1000">
                <div class="text-blue-500 font-medium mb-2">How It Started</div>
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Our Dream is Island Travel Exploration
                </h2>

                <p class="text-gray-600 mb-8 text-base md:text-lg">
                    DreamIslands was founded by Michael Chen and Sophia Rodriguez, passionate travelers with a shared love for island destinations. Their journey began after discovering the hidden beauty of remote islands that were difficult for travelers to access. United by their belief in making paradise accessible to all, they embarked on a mission to build "DreamIslands." With dedication and local partnerships, they created a network connecting travelers to the most beautiful islands around the world.
                </p>
                ...
                <form class="space-y-6" data-aos="fade-up" data-aos-delay="200" data-aos-duration="800">
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" name="first-name" id="first-name" class="py-3 px-4 block w-full shadow-sm focus:ring-blue-500 focus:border-blue-500 border-gray-300 rounded-md">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" name="last-name" id="last-name" class="py-3 px-4 block w-full shadow-sm focus:ring-blue-500 focus:border-blue-500 border-gray-300 rounded-md">
                            </div>
                        </div>
                    </div>
